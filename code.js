...
months[11] = null;
console.log(months);
// Another way to delete the last item in an array
months.pop();
console.log(months);
...
dogs.forEach((breedName) => {
  console.log(`The ${breedName} needs to go for a walk!`);
});
...
const shoutyDogNames = dogs.map((shoutName) => {
  return shoutName.toUpperCase();
});
...
person.favoriteFoods = ["Pizza", "Pasta", "Hamburger"];
console.log(person);
